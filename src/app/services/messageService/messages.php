<?php
    ...
    $insert = "INSERT INTO messages (name,company,email,assunto,help) VALUES ('$name', '$company', '$email', '$subject', '$help')";
    $insertQuery = mysqli_query($connect, $insert);
    
    //configura e envia o email

    $dest = "financeiro@techlinetelecom.com.br";

    $body = "Você recebeu uma mensagem através do FALE CONOSCO"."\n\n";
    $body = $body." nome: ".$name."\n";
